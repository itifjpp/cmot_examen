        <div class="footer-wrapper margin-top-100" >
            <div class="footer" >
                 <!---->
                <div class="footer-top" style="background: url(<?=  base_url()?>assets/img/slider5.png);background-size: cover;background-position: center;padding: 0px 0px 20px 0px">
                    <div style="background: rgba(54, 28, 3, 0.3);background-size: cover;width: 100%;height: 100%;margin-top:0px;margin-bottom: -80px;padding: 50px">
                    <div class="container" style="">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="footer-top-block">
                                    <h2>Qué es el CMOT</h2>

                                    <p class="text-justify">
                                    El Consejo no es una Sociedad Médica, es un órgano colegiado registrado ante la Academia Nacional de Medicina, Institución designada por las autoridades de la Secretaría de Salud [1] para organizar a los Consejos de Especialidades Médicas. Hasta la Fecha existen registrados oficialmente 47 Consejos, de los cuales, el de Ortopedia es de los más antiguos y de los que cuenta con una organización más consistente.     
                                    </p>
                            ...
                            <div class="col-md-6 ">
                                <div class="footer-top-block">
                                    <h2>Oficinas/Horarios</h2>
                                    <p>
                                        <i class="fa fa-map-marker"></i> Montecito 38 piso 26 oficinas 31 y 32, Colonia Nápoles. México, D.F. CP. 03810
                                        <br><i class="fa fa-phone"></i> <a href="tel:(55) 9000-42-58" style="text-decoration: none;color: white"> (55) 9000-42-58 al 61</a>
                                        <br><i class="fa fa-envelope"></i> <a href="mailto:info@cmot.org.mx" style="text-decoration: none;color: white">info@cmot.org.mx</a>
                                    </p>
                                    <p>
                                        Lunes a Viernes: 10am a 6pm<br>
                                        Sábado:  Cerrado<br>
                                        Domingo: Cerrado
                                    </p>
                                    <p></p>
                ...
                <div class="footer-bottom" style="padding: 10px;">
                    <div class="container" style="margin-top: 10px">
                        <div class="col-md-6 text-center" style="font-size: 12px">
                            <p>&copy; Derechos reservados 2016 | Sitio desarrollado por bienTICS</p>
                        </div>
                        <div class="col-md-6 text-center" style="font-size: 12px">
                            <p>
                                <a href="<?=  base_url()?>assets/doc/aviso_privacidad_cmot.pdf" target="_blank" class="no-link">Aviso de privacidad</a>
                                | 
                                <a href="<?=  base_url()?>assets/doc/politicas_privacidad_cmot.pdf" target="_blank" class="no-link">Politicas de Privacidad</a>
                            </p>
                        </div>
                        <div class="col-md-1 hidden text-center" style="font-size: 15px">
