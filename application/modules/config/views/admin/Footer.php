        ...
        <script type="text/javascript" src="<?=base_url() ?>assets_dash/js/jquery-1.3.2.js"></script>
        ...
        <script src="<?=  base_url()?>assets/libraries/bootstrap-fileinput/js/fileinput.js"></script>
        <script src="<?=  base_url()?>assets/libraries/bootstrap-fileinput/js/fileinput_locale_es.js"></script>
        <script src="<?=  base_url()?>assets_dash/plugins/bootstrap-datepicker/js/bootstrap-datepicker.js" type="text/javascript"></script>
        
        <script src="<?=  base_url()?>assets_dash/plugins/bootstrap-wysihtml5/wysihtml5-0.3.0.js" type="text/javascript"></script>
        <script src="<?=  base_url()?>assets_dash/plugins/bootstrap-wysihtml5/bootstrap-wysihtml5.js" type="text/javascript"></script>
        <script src="<?=  base_url()?>assets_dash/plugins/bootstrap-timepicker/js/bootstrap-timepicker.min.js" type="text/javascript"></script>
        <script src="<?=  base_url()?>assets_dash/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.js" type="text/javascript"></script>
        ...
        <script src="<?=  base_url()?>assets_dash/plugins/boostrap-clockpicker/bootstrap-clockpicker.min.js" type="text/javascript"></script>
        <script src="<?=  base_url()?>assets_dash/plugins/jquery-numberAnimate/jquery.animateNumbers.js" type="text/javascript"></script>
        <script src="<?=  base_url()?>assets_dash/plugins/bootstrap-select2/select2.min.js" type="text/javascript"></script>
        ...
        <script src="<?=  base_url()?>assets_dash/plugins/html5imageupload/html5imageupload.js" type="text/javascript"></script>
        <script src="<?=  base_url()?>assets_dash/plugins/jquery-notifications/js/demo/demo.js" type="text/javascript" ></script>    
        <script src="<?=  base_url()?>assets_dash/js/md5.js" type="text/javascript" ></script>   
        <script src="<?=  base_url()?>assets_dash/plugins/footable/footable.all.min.js" type="text/javascript"></script>
        <script src="<?=  base_url()?>assets_dash/js/tabs_accordian.js" type="text/javascript"></script>
        <script src="<?=  base_url()?>assets_dash/js/core.js" type="text/javascript"></script> 
        <script type="text/javascript" src="<?=  base_url()?>assets/js/bootbox.min.js"></script> 
        <script src="<?=  base_url()?>assets_dash/js/mensajes.js" type="text/javascript"></script> 
        <script src="<?=  base_url()?>assets_dash/js/inicio.js" type="text/javascript"></script> 
        <script src="<?=  base_url()?>assets_dash/js/datatables.js" type="text/javascript"></script>
    </body>
</html>