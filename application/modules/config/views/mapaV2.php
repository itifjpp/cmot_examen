...
<html>
    ...
    <body>
    <script src="https://maps.googleapis.com/maps/api/js?sensor=false&key=AIzaSyAb3I2FAzlE4y3qeYMmLUzuwJtrSnjHzpA&amp;v=3.exp"></script>
    <script>
        //getGeo();
        function getGeo(){
    ...
    <style>
        ...
        <script>
            ...
            var GuardarDireccion=function (){
                ...
                $("#OK").click(function (){
                    if($('#direccion').val()!=''){
                        window.opener.document.getElementsByClassName('<?=$_GET['d']?>')[0].value=document.all.direccion.value;
                        //window.opener.document.getElementsByClassName('<?=$_GET['lat']?>')[0].value=document.all.latitud.value;
                        //window.opener.document.getElementsByClassName('<?=$_GET['log']?>')[0].value=document.all.longitud.value;
                        window.close();
                        //miventana.close()
                    }
                });
