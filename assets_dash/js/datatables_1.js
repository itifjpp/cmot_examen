...
$(document).ready(function() {
	...
	$('#example_wrapper .dataTables_filter input').addClass("input-medium form-control"); // modify table search input
     ...
     */
    $('body .dataTables_length').addClass('hidden');
    $('body .DTTT').addClass('hidden');
    $('body .dataTables_info').css({
        'margin-top':'10px'
    })
