 ...
 * Version    : 2.4.0                                            *
 * Updated    : 2015-04-06 21:14:29 UTC+02:00                    *
 * Developer  : Mark                                             *
 * Dependency :                                                  *
 * Lib        : jQuery 1.7+                                      *
 * Licence    : NOT free                                         *
	...
	Plugin.prototype = {
		...
		**/
		_endTour: function(type){ 
			...
			* Reset mask.
			**/	
			$('#'+c_pwmk).animate({opacity: 0}, (isNaN(highlightEndSpeed)) ? 1000 : highlightEndSpeed, function(){
		...
		run: function(tour){ 
			...
			**/	
			if($.isArray(tour)){
				...
				var tourVar   = (tourVar == 0) ? 1 : tourVar;			
				var st        = self.o.tours[tourVar].startWith;				
