				...
				//*****************************************************************//
					...
					**/
					function endTour(val){
						...
						**/	
						if(o_tourType == 'auto' && o_tourType == 'step' && val != undefined && typeof o_step[parseInt(val -1)].onHideStep == 'function'){
							o_step[parseInt(val -1)].onHideStep.call(this);
						}
						...
						**/	
						if (cur >= totalSteps){
							...
							**/	
							...
							var valuePrev = o_step[parseInt(cur -1)];
				...
				//*****************************************************************//
					...
					**/
					function goToStep(i){
						...
						**/	
						var value     = o_step[i];				
						var valuePrev = o_step[parseInt(i -1)];		
						...
						**/
						if($(e.target).is($('#powertour-time-stop'))){
							...
							**/
						    ...
						    var curStep = $('.powertour[data-tour-id="'+mainId+'"]:visible').data('tour-step');
