$(document).ready(function($){
	...
	$('#generateoutput').click(function(e){
		...
		$('.tour-wrapper').each(function(i,e){
			...
			output += 'highlightStartSpeed:'+$(this).find("[name=highlightStartSpeed]").val()+',\n';
			output += 'highlightEndSpeed:'+$(this).find("[name=highlightEndSpeed]").val()+',\n';
			...
			$(this).find('.step-wrapper').each(function(ii,ee){
				...
				output += 'keepVisible:'+$(this).find("[name=keepVisible]").val()+',\n';
			...
			output += 'stepDefaults: [';
				...
				output += 'keepVisible:'+$(this).find("[name=default-keepVisible]").val()+',\n';
