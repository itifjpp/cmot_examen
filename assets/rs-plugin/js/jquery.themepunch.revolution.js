		...
		function prepareSlides(container,opt) {
			...
			container.find('>ul:first >li').each(function(j) {
				...
				if (li.data('link')!=undefined) {
					...
					if (link=="slide") {
						li.append('<div class="tp-caption sft slidelink" style="z-index:'+zindex+';word-wrap: break-word!important;" data-x="0" data-y="0" data-linktoslide="'+linktoslide+'" data-start="0"><a><div></div></a></div>');
					} else {
						linktoslide="no";
						li.append('<div class="tp-caption sft slidelink" style="z-index:'+zindex+';word-wrap: break-word!important;" data-x="0" data-y="0" data-linktoslide="'+linktoslide+'" data-start="0"><a target="'+target+'" href="'+link+'"><div></div></a></div>');
					}
